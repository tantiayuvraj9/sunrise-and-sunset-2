...
!(function (t, e) {
                ...
                if ("string" == typeof i) {
                    ...
                    if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(o) > -1)
                        if (t.prototype.isFileSupported(o)) n = n;
                            ...
                            for (
                                var r = n.split("."), s = r[r.length - 1], a = 0; a < e.extensions.length; a++
                            ) {
    ...
    a = (function () {
                ...
                if ((t || (t = 5 * window.width), this.buffer)) {
                    for (
                        ...
                        for (var a = e.getChannelData(s), u = 0; t > u; u++) {
                            for (
                                var c = ~~(u * i), p = ~~(c + i), h = 0, l = c; p > l; l += n
                            ) {
                                var f = a[l];
                                f > h ? (h = f) : -f > h && (h = f);
                            }
        ...
        (t.SoundFile.prototype._onTimeUpdate = function (t) {
            for (
                var e = t / this.buffer.sampleRate, i = this._cues.length, n = 0; i > n; n++
            ) {
                var o = this._cues[n],
                    r = o.time,
                    s = o.val;
    ...
    c = (function () {
        ...
        (t.FFT.prototype.getCentroid = function () {
            for (
                var t = e.audiocontext.sampleRate / 2, i = 0, n = 0, o = 0; o < this.freqDomain.length; o++
            )
    ...
    p = (function () {
        ...
        (t.prototype._collectDefaults = function (t) {
            ...
            if (
                ...
                for (
                    var i = this._collectDefaults(t._super), n = 0; n < i.length; n++
                )
                    -
    ...
    f = (function (t) {
        return (
            ...
            (t.TimeBase.prototype._parseBinary = function (t, e) {
                ...
                for (
                    var n = t.peek(); n && this._matchGroup(n, this._binaryExpressions, e);
    ...
    d = (function (t) {
        return (
            ...
            (t.Time.prototype._toNotationHelper = function (t, e) {
                for (
                    var i = this._notationToUnits(e[e.length - 1]), n = "", o = 0; o < e.length; o++
                ) {
            ...
            (t.Time.prototype._notationToUnits = function (t) {
                for (
                    var e = this._primaryExpressions, i = [e.n, e.t, e.m], n = 0; n < i.length; n++
                ) {
                    var o = i[n],
                        r = t.match(o.regexp);
            ...
            (t.Clock.prototype._loop = function () {
                for (
                    var e = this.now(),
                        ...
                        r = e + i + n + o; r > this._nextTick && this._state;
    ...
    rt = (function () {
        function e(t, e) {
            for (
                var i = t.length + e.length, n = new Float32Array(i), o = 0, r = 0; i > r;
